...
const Login = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Login - PrecificaImóvel Já</title>
        <meta name="description" content="Acesse sua conta para continuar avaliando imóveis." />
      </Helmet>
            ...
            <CardContent>
              ...
              <div className="mt-6 text-center text-sm">
                <p className="text-white/70">
                  Não tem uma conta?{' '}
                  <Link to="/cadastro" className="font-medium text-indigo-400 hover:underline">
                    Cadastre-se
                  </Link>
                </p>
              </div>
